package net.tyler.tutorialmod.effect;
...
public class ModEffects {
    public static final RegistryEntry<StatusEffect> SPIDY = registerStatusEffect("spidy",
            new SpidyEffect(StatusEffectCategory.NEUTRAL, 0x36ebab)
                    .addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED,
                            Identifier.of(TutorialMod.MOD_ID, "spidy"), -0.25f,
